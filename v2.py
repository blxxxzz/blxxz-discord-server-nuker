...
os.system('cls')
print(f"""
                                {colors.purple}██{Fore.WHITE}╗  {colors.purple}██{Fore.WHITE}╗{colors.purple}███{Fore.WHITE}╗   {colors.purple}██{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}╗   {colors.purple}██{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}╗  {colors.purple}██{Fore.WHITE}╗{colors.purple}███████{Fore.WHITE}╗{colors.purple}██████{Fore.WHITE}╗ 
                                {Fore.WHITE}╚{colors.purple}██{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}╔╝{colors.purple}████{Fore.WHITE}╗  {colors.purple}██{Fore.WHITE}║{colors.purple}██{Fore.WHITE}║   {colors.purple}██{Fore.WHITE}║{colors.purple}██{Fore.WHITE}║ {colors.purple}██{Fore.WHITE}╔╝{colors.purple}██{Fore.WHITE}╔════╝{colors.purple}██{Fore.WHITE}╔══{colors.purple}██{Fore.WHITE}╗
                                 {Fore.WHITE}╚{colors.purple}███{Fore.WHITE}╔╝ {colors.purple}██{Fore.WHITE}╔{colors.purple}██{Fore.WHITE}╗ {colors.purple}██{Fore.WHITE}║{colors.purple}██{Fore.WHITE}║   {colors.purple}██{Fore.WHITE}║{colors.purple}█████{Fore.WHITE}╔╝ {colors.purple}█████{Fore.WHITE}╗  {colors.purple}██████{Fore.WHITE}╔╝
                                 {colors.purple}██{Fore.WHITE}╔{colors.purple}██{Fore.WHITE}╗ {colors.purple}██{Fore.WHITE}║╚{colors.purple}██{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}║{colors.purple}██{Fore.WHITE}║   {colors.purple}██{Fore.WHITE}║{colors.purple}██{Fore.WHITE}╔═{colors.purple}██{Fore.WHITE}╗ {colors.purple}██{Fore.WHITE}╔══╝  {colors.purple}██{Fore.WHITE}╔══{colors.purple}██{Fore.WHITE}╗
                                {colors.purple}██{Fore.WHITE}╔╝ {colors.purple}██{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}║ ╚{colors.purple}████{Fore.WHITE}║╚{colors.purple}██████{Fore.WHITE}╔╝{colors.purple}██{Fore.WHITE}║  {colors.purple}██{Fore.WHITE}╗{colors.purple}███████{Fore.WHITE}╗{colors.purple}██{Fore.WHITE}║  {colors.purple}██{Fore.WHITE}║
                                {Fore.WHITE}╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝


                                          {colors.purple}╭╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╮
                                          {colors.purple}╽       {Fore.WHITE}Paste Your Token       {colors.purple}╽
                                          {colors.purple}╿          {Fore.WHITE}To Login.{colors.purple}           ╿
                                          ╰╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╯      


""")       
token = input(f"                                          {Fore.WHITE}~/{colors.purple}Token{Fore.WHITE}$ {colors.purple}")
    ...
    async def Menu(self):
        ...
        print(f'''
                                ...
                                {Fore.WHITE}╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
                                           ...
                                           {colors.purple}╭╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╮
                                           {colors.purple}╽ {Fore.LIGHTBLACK_EX}h {Fore.WHITE}- {colors.purple}{Fore.WHITE}Webhook Spammer        {colors.purple}╽
                                           {colors.purple}╽ {Fore.LIGHTBLACK_EX}1 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Ban Members            {colors.purple}╽
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}2 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Kick Members           {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}3 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Prune Members          {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}4 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Role Deletor           {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}5 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Channel Deletor        {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}6 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Role Creator           {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}7 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Channel Creator        {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}8 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Nuke Server            {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}9 {Fore.WHITE}- {colors.purple}{Fore.WHITE}Scrape Server          {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}G {Fore.WHITE}- {colors.purple}{Fore.WHITE}Change Guild Name      {colors.purple}┃
                                           {colors.purple}┃ {Fore.LIGHTBLACK_EX}C {Fore.WHITE}- {colors.purple}{Fore.WHITE}Credits                {colors.purple}┃
                                           {colors.purple}╿ {Fore.LIGHTBLACK_EX}X {Fore.WHITE}- {colors.purple}{Fore.WHITE}Exit                   {colors.purple}╿
                                           {colors.purple}╰╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╯ 
...
##################vvv CHOOISE vvv##################
        ...
        choice = input(f'                                            {Fore.WHITE}~/{colors.purple}Number{Fore.WHITE}$ {colors.purple}')
        if choice == '1':
